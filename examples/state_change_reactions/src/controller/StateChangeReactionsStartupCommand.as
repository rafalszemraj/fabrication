...
package controller {
    ...
    import view.StateChangeReactionsMediator;

    public class StateChangeReactionsStartupCommand extends SimpleFabricationCommand {

        override public function execute(notification:INotification):void
        {
            super.execute(notification);
            Log.getLogger().addChannel( FabricationLoggerChannel.getInstance() );
            registerMediator( new StateChangeReactionsMediator( notification.getBody() as StateChangeReactions ) );
        }
    }
}